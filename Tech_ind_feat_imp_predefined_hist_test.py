'''
Info: this script runs an analysis where train and test sets are predefined. The features used to make predictions on
the test set are extracted from a feature importances analysis carried out on the previous training set
'''
...
#train_period_dict = {0: ['2015-01-01', '2015-12-31'], 1: ['2016-01-01', '2016-12-31'], 2: ['2017-01-01', '2017-12-31'],
#                     3: ['2018-01-01', '2018-12-31']}
#test_period_dict = {0: ['2019-01-01', '2019-12-31'], 1: ['2020-01-01', '2020-12-31'], 2: ['2021-01-01', '2021-12-31'],
#                    3: ['2022-01-01', '2022-12-31']}

train_period_dict = {0: ['2015-01-01', '2016-12-31'], 1: ['2017-01-01', '2018-12-31']}
test_period_dict = {0: ['2019-01-01', '2020-12-31'], 1: ['2021-01-01', '2022-12-31']}

## inputs for features creation
vals_rsi = [7, 30, 90, 180]
vals_sma = [14, 30, 90, 120, 180]
vals_pctChange = [7, 30, 90, 180]
...
ps = For_test_split.Predefined_ts_split(train_period_dict, test_period_dict)
for i, (train_dates_, test_dates_) in enumerate(ps.split()):
    train_dates = data.loc[train_dates_[0]: train_dates_[-1]].index
    test_dates = data.loc[test_dates_[0]: test_dates_[-1]].index
    print('Train fold:', train_dates[0], train_dates[-1], '. # of samples:', len(train_dates))
    print('Test fold:', test_dates[0], test_dates[-1],  '. # of samples:', len(test_dates))
    ps.plot_sets(train_dates, test_dates, outer_i)
